...
while True:
        ...
        # read the analog pin
        moisture_value = readadc(moisture_adc, SPICLK, SPIMOSI, SPIMISO, SPICS)
        # how much has it changed since the last read?
        moisture_adjust = abs(moisture_value - last_read)

        if DEBUG:
                print "moisture_value:", moisture_value
                print "moisture_adjust:", moisture_adjust
                print "last_read", last_read

        if ( moisture_adjust > tolerance ):
